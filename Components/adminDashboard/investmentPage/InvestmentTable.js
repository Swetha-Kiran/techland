...
import data from "../investmentPage/investmentData"
            ...
            <table className='bg-re-300 w-full'>
                <thead className='bg-yello-300 pb-10' >
                    <tr className='mb-4 text-base 2xl:text-lg text-[#428358] font-normal flex opacity-70  justify-between gap-x-2'>
                        <th className='bg-blu-300 w-[10vw] text-center' >Packages Name</th>
                        <th className='bg-blu-300 w-[6vw] text-center'>Price</th>
                        <th className='bg-blu-300 w-[14vw] text-center'>Time Period</th>
                        <th className='bg-blu-300 w-[6vw] text-center '>Status</th>
                        <th className='bg-blu-300 w-[14vw] text-center'>Description</th>
                        <th className='bg-blu-300 w-[10vw] text-center'>Actions</th>
                    </tr>
                </thead>
                <tbody >
                    {isLoading ?
                        ...
                        filteredItems.map((curItem, index, array) => {
                            return (
                                <tr key={index} className='mb-4 text-sm 2xl:text-lg text-[#000000] font-normal flex   opacity-70 justify-between gap-x-2'>
                                    ...
                                    <td className='bg-blu-300 w-[10vw] flex flex-row'>
                                        <Image src="/dashboardImages/miniland.svg" width={60} height={40} alt="miniland"></Image>
                                        {curItem.packageName}</td>
                                    <td className='bg-blu-300 w-[6vw] text-center'>{curItem.price}</td>
                                    <td className='bg-blu-300 w-[14vw] text-center'>{curItem.time}</td>
                                    <td className='bg-blu-300 w-[6vw] text-center bg-[#90BE6D] flex items-center justify-center px-4 rounded-[32px] text-[#FFFFFF]'>{curItem.status}</td>
                                    <td className='bg-blu-300 w-[14vw] text-center'>{curItem.description}</td>
                                    <td className='bg-blu-300 w-[10vw] flex flex-row justify-around items-center cursor-pointer'>
                                    <RiDeleteBin6Line />
                                    <MdEditNote />
                                    </td>
                                </tr>
